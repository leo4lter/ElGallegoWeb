...
const imageConfigs: ImageConfig[] = [
  {
    ...
    description: 'Aparece en la barra de navegación y en el pie de página.',
    dimensions: '200 x 56 px',
    formats: 'PNG o SVG',
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-charcoal-500 mt-1">Sube el logo y el favicon que aparecen en la página.</p>
      </div>
        ...
        {imageConfigs.map((config) => (
          <div key={config.key} className="admin-card p-6">
            ...
            <div className="flex items-center gap-5 mb-4">
              <div
                className="overflow-hidden bg-charcoal-100 border border-charcoal-200 flex items-center justify-center flex-shrink-0"
                style={{ width: config.previewSize, height: config.previewSize }}
              >
                <img
              ...
              <div className="flex-1">
                <div className="bg-charcoal-50 border border-dashed border-charcoal-300 px-4 py-3 mb-2">
